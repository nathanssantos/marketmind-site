      ...
      <Container>
        <div className="flex h-16 items-center justify-between">
          <a href="#" className="flex items-center gap-2.5">
            <Image src="/images/logo.svg" alt="MarketMind" width={32} height={32} priority />
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              ...
              className="hidden items-center gap-2 rounded-lg bg-gray-900 px-3.5 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200 sm:inline-flex"
            >
              <svg
            ...
            <div className="flex flex-col gap-1">
              {siteConfig.nav.map((item) => (
                <a
                  ...
                  className="rounded-lg px-3 py-2.5 text-sm text-gray-600 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                >
                  {t(item.key)}
                </a>
              ))}
